...
public class MainDriverLog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSiguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (registrado){
                    Intent seguir = new Intent(MainDriverLog.this, MainEspacio.class);
    ...
    public void enviarDatos() {
        Intent intent = new Intent(MainDriverLog.this, MainFormulario.class);
